...
Thanks to Allen Bierbaum :doc:`Py++ <pyplusplus>` now has `wiki`_. We use it primary to
...
* `A rationale for semantically enhanced library languages`_
  ...
  :doc:`Py++ <pyplusplus>` + Boost.Python is a SELL!
...
* `Aspect oriented programming`_
  ...
  :doc:`Py++ <pyplusplus>` borrowed few ideas from this programming paradigm.
...
* http://pygccxml.svn.sourceforge.net/viewvc/pygccxml/pyplusplus_dev/unittests/ - :doc:`Py++ <pyplusplus>`
